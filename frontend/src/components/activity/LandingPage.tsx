...
const LandingPage: React.FC = () => {
  return (
    <div className="flex flex-col justify-center items-center min-h-screen dark:bg-gray-700 dark:text-white transition-colors duration-300">
      ...
      <p className="text-lg text-center mb-8 w-3/6">
